<?php
/*
 * Class Name: WP_Sciencexlite_Bootstrap_Navwalker
...
if ( ! class_exists( 'WP_Sciencexlite_Bootstrap_Navwalker' ) ) {
	/**
	 * WP_Sciencexlite_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class WP_Sciencexlite_Bootstrap_Navwalker extends Walker_Nav_Menu {
